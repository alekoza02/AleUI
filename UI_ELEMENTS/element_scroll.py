...
class Scroll(BaseElementUI):
    def __init__(self, x, y, w, h, origin=None, title="click me", performant=False):
        ...
        self.shape.add_shape("bg_selectable", RectAle("0cw", "3sh", "100cw", "100ch -3sh", [50, 50, 50], 0, 0, is_opengl=size._is_opengl))
        
        self.componenets: dict[str, Label_text] = {
            "_title" : Label_text("0px", "0px", "100cw", "3sh", "left-up", text=title, text_tag_support=False, render_bg=False, text_centered_x=False, font_scale=1.5)
        }
