...
def build_dev_scene(app: 'App') -> 'App':
    app.UI["top_bar"] = Container("0vh 10px", "0.5vh", "100vw -20px", "2vh", None, performant=1)
    
    app.UI["interactive_tools"] = Container("10px", "3vh", "4vw", "94vh", None, performant=1)
    
    app.UI["plot_explorer"] = Container("65vw", "3vh", "35vw -10px", "33vh", None, performant=1)
    app.UI["plot_explorer"].add_element("plot_selector", Scroll("50cw", "50ch", "99cw", "99ch", "center-center", title="Plot Explorer", performant=1))
    
    app.UI["settings"] = Container("70vw", "36vh 10px", "30vw -10px", "61vh -10px", None, performant=1, scrollable=True)
    
    app.UI["tab_selecter"] = Container("65vw", "36vh 10px", "5vw -5px", "61vh -10px", None, performant=1)
    
    app.UI["viewport"] = Container("4vw 20px", "3vh", "61vw -30px", "94vh", None, performant=1)
    ...
    app.UI["STATS"].add_element("BATTERY", Label_text("0cw", "50ch", "0cw", "100ch -4px", "right-center", "BATTERY", text_tag_support=True, fixed_number_of_chars=7, performant=1))
    app.UI["STATS"].add_element("FPS", Label_text("0cw", "50ch", "0cw", "100ch -4px", "right-center", "FPS", text_tag_support=True, fixed_number_of_chars=12, performant=1))
    app.UI["STATS"].add_element("CPU", Label_text("0cw", "50ch", "0cw", "100ch -4px", "right-center", "CPU", text_tag_support=True, fixed_number_of_chars=12, performant=1))
